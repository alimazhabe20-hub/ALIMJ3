    ...
    if data and data.startswith("ec:"):
        ...
        try:
            ...
            if data == "ec:ai":
                ...
                prompt = (
                    "تو تحلیل‌گر ارشد اقتصاد کلان و بازارهای مالی هستی. یک گزارش تحلیلی فارسیِ کامل اما منظم بنویس. "
                    "فقط از داده‌های تقویم که پایین آمده استفاده کن؛ هیچ عدد، خبر، قیمت یا رویداد بیرونی را اضافه نکن. "
                    "رویدادهای High و Medium را در اولویت قرار بده و اگر چند رویداد به هم مرتبط‌اند، اثر ترکیبی آنها را توضیح بده. "
                    "برای هر رویداد مهم: ۱) معنی و اهمیت، ۲) Actual در برابر Forecast، ۳) Actual در برابر Previous، "
                    "۴) اینکه داده به نفع یا به ضرر ریسک‌پذیری/دلار است، و ۵) اثر احتمالی روی بیت‌کوین، اتریوم، آلت‌کوین‌ها، "
                    "DXY، طلا، سهام و اوراق/بازدهی را توضیح بده. برای داده‌های منتشرنشده، از Forecast و Previous فقط سناریو بساز و آن را "
                    "به‌عنوان واقعیت جا نزن. برای داده‌های بدون Forecast، صریحاً بگو مقایسه با Forecast ممکن نیست. "
                    "به تفاوت «داده واقعی» و «سناریوی احتمالی» پایبند باش. هیچ سیگنال قطعی خرید/فروش و هیچ تضمینی نده. "
                    "در پایان حتماً این بخش‌ها را بیاور: «جمع‌بندی داده‌های منتشرشده»، «رویدادهای مهم پیش‌رو»، "
                    "«اثر کلان بر ریسک‌پذیری»، «کریپتو»، «دلار/DXY»، «طلا»، «سهام»، «اوراق و بازدهی»، "
                    "«سناریوی پایه»، «سناریوی صعودی»، «سناریوی نزولی»، «مهم‌ترین ریسک‌ها و ابهام‌ها». "
                    "اگر داده کافی برای نتیجه‌ای وجود ندارد، همان را شفاف اعلام کن. پاسخ بدون Markdown و بدون جدول باشد.\n\n"
                    "داده تقویم:\n" + context_text[:5600]
                )
