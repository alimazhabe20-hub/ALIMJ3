...
def register_builtin_plugins() -> None:
    specs = (
        PluginSpec("ai", "39.x", "AI providers, routing and context", tags=("core", "ai")),
        PluginSpec("weather", "39.x", "Weather and air-quality features", tags=("feature",)),
        PluginSpec("market", "39.x", "Market and crypto features", tags=("feature",)),
        PluginSpec("media", "39.x", "Image, voice and media AI features", tags=("feature", "ai"), dependencies=("ai",)),
        PluginSpec("knowledge", "39.x", "Knowledge base and retrieval", tags=("rag",), dependencies=("ai",)),
        PluginSpec("agents", "39.x", "Workflow, autonomous and multi-agent execution", tags=("agent",), dependencies=("ai", "knowledge")),
        PluginSpec("automation", "39.x", "Scheduled proactive assistant", tags=("automation",)),
    )
    for spec in specs:
        register(spec)
