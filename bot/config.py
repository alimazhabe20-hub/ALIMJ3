...
class Config:
    ...
    HTTP_CIRCUIT_FAILURE_THRESHOLD = int(os.getenv("HTTP_CIRCUIT_FAILURE_THRESHOLD", "3"))
    HTTP_CIRCUIT_COOLDOWN = float(os.getenv("HTTP_CIRCUIT_COOLDOWN", "30"))
    ALERT_DEDUP_TTL = int(os.getenv("ALERT_DEDUP_TTL", "900"))
    ...
    AUTO_REACTIONS_COOLDOWN = max(0.0, float(os.getenv("AUTO_REACTIONS_COOLDOWN", "8")))
