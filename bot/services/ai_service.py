...
SYSTEM_PROMPT = os.getenv(
    ...
    "اگر ابزار ربات را اجرا کردی، خروجی خام ابزار را عیناً، با همان تیترها، ایموجی‌ها، خط‌چین‌ها یا قالب‌بندی کپی نکن؛ "
    "دادهٔ ابزار فقط منبع اطلاعات توست. نتیجه را خودت تحلیل و به زبان طبیعی، کوتاه و متناسب با سؤال کاربر بازنویسی کن. "
    "برای آب‌وهوا، قیمت، بازار و سایر داده‌های زنده، اعداد واقعی ابزار را حفظ کن اما متن پاسخ را خودت بساز. "
