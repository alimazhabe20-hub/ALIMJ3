...
# ---------------- UX ----------------
TEXTS = {
    "fa": {"download_title": "📥 دانلودر فایل حرفه‌ای", "invalid": "❌ لینک معتبر http/https بفرستید.", "checking": "🔎 در حال بررسی لینک…", "downloading": "⏬ در حال دانلود…", "ready": "✅ فایل آماده شد."},
    "en": {"download_title": "📥 Professional File Downloader", "invalid": "❌ Send a valid http/https URL.", "checking": "🔎 Checking link…", "downloading": "⏬ Downloading…", "ready": "✅ File is ready."},
    "ar": {"download_title": "📥 مُنزّل الملفات الاحترافي", "invalid": "❌ أرسل رابط http/https صالحاً.", "checking": "🔎 جارٍ فحص الرابط…", "downloading": "⏬ جارٍ التنزيل…", "ready": "✅ الملف جاهز."},
}
