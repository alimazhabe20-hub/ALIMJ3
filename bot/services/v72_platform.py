...
# ---------------- UX ----------------
TEXTS = {
    "fa": {"download_title":"📥 دانلودر فایل حرفه‌ای","intro":"لینک عمومی را بفرستید. YouTube، Instagram، TikTok، Facebook و بسیاری از سایت‌های دیگر، به‌علاوه لینک مستقیم فایل پشتیبانی می‌شود.\n\nکیفیت/فرمت بعد از بررسی لینک انتخاب می‌شود. سقف ارسال مستقیم ۴۸MB است.\n⚠️ CAPTCHA، ورود اجباری، محتوای خصوصی، DRM و مسدودی سایت دور زده نمی‌شود.","invalid":"❌ لینک معتبر http/https بفرستید.","checking":"🔎 در حال بررسی لینک و کیفیت‌های قابل دریافت…","downloading":"⏬ در حال دانلود…","ready":"✅ فایل آماده شد.","cancelled":"❌ دانلود لغو شد.","expired":"⚠️ این درخواست منقضی شده است. لینک را دوباره بفرستید.","prepared":"📥 لینک آماده است","choose":"فرمت/کیفیت را انتخاب کنید:","sending":"در حال ارسال…","probe_failed":"⚠️ بررسی لینک ناموفق بود. دوباره امتحان کنید."},
    "en": {"download_title":"📥 Professional File Downloader","intro":"Send a public URL. YouTube, Instagram, TikTok, Facebook and many other sites, plus direct file links, are supported.\n\nQuality/format is selected after link inspection. Direct sending limit: 48MB.\n⚠️ CAPTCHA, mandatory login, private content, DRM and site blocks are not bypassed.","invalid":"❌ Send a valid http/https URL.","checking":"🔎 Checking the link and available qualities…","downloading":"⏬ Downloading…","ready":"✅ File is ready.","cancelled":"❌ Download cancelled.","expired":"⚠️ This request has expired. Send the link again.","prepared":"📥 Link is ready","choose":"Choose format/quality:","sending":"Sending…","probe_failed":"⚠️ Link inspection failed. Please try again."},
    "ar": {"download_title":"📥 مُنزّل الملفات الاحترافي","intro":"أرسل رابطاً عاماً. يدعم YouTube وInstagram وTikTok وFacebook والعديد من المواقع الأخرى، إضافةً إلى روابط الملفات المباشرة.\n\nيتم اختيار الجودة/الصيغة بعد فحص الرابط. حد الإرسال المباشر: 48MB.\n⚠️ لا يتم تجاوز CAPTCHA أو تسجيل الدخول الإجباري أو المحتوى الخاص أو DRM أو حظر المواقع.","invalid":"❌ أرسل رابط http/https صالحاً.","checking":"🔎 جارٍ فحص الرابط والجودات المتاحة…","downloading":"⏬ جارٍ التنزيل…","ready":"✅ الملف جاهز.","cancelled":"❌ تم إلغاء التنزيل.","expired":"⚠️ انتهت صلاحية هذا الطلب. أرسل الرابط مرة أخرى.","prepared":"📥 الرابط جاهز","choose":"اختر الصيغة/الجودة:","sending":"جارٍ الإرسال…","probe_failed":"⚠️ تعذر فحص الرابط. حاول مرة أخرى."},
}
